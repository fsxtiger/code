 ...
 **/
public class Config {
    public static final String NAME = "AiCourse";
    ...
    public static final String DOWN_STREAM_SERVICE_NAME = "Course";
    ...
    public static final String CLASS_NAME = "cn.golingo.glep.education.controller.student.ai.AiCourseController";
    ...
    public static final String FULL_CONVERT_PATH = "cn.golingo.glep.admin.provider.convert." + Config.NAME + "Convert";
